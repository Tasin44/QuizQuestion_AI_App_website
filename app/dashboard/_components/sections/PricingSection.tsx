  ...
  return (
    <section id="pricing" style={{ padding: "80px 40px", textAlign: "center", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "24px" }}>
        {plans.map((p) => (
          <div key={p.name} style={{ backgroundColor: "#111118", borderRadius: "16px", border: p.popular ? "1px solid rgba(79,70,229,0.4)" : "1px solid rgba(255,255,255,0.06)", padding: "36px 28px", textAlign: "left", position: "relative", transition: "all 0.3s ease" }}
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginBottom: "28px" }}>
              <span style={{ color: "#ffffff", fontSize: "40px", fontWeight: 700 }}>{p.price}</span>
